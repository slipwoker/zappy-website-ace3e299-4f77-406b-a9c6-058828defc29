...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        const validateField = (input) => {
            const fieldName = input.name || input.getAttribute('data-validate') || input.type;
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            inputs.forEach(input => {
                if (input.required || input.hasAttribute('data-validate')) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ace3e299-4f77-406b-a9c6-058828defc29',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ace3e299-4f77-406b-a9c6-058828defc29';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ace3e299-4f77-406b-a9c6-058828defc29';
